...
course_2_df <- as.data.frame.matrix(course_2)

course_3_4 <- data.frame(table(data_clean_3_4$"3_4"))

course_3_4_df <- as.data.frame.matrix(course_3_4)
...
cloud_1 <- wordcloud(course_1_df$Var1, course_1$Freq, min.freq = 1)

cloud_2 <- wordcloud(course_2_df$Var1, course_2$Freq, min.freq = 1)
