...
```{r, results=FALSE, message = FALSE, warning = FALSE, class.source = 'fold-show'}
...
```{r, fig.width = 15, fig.height = 34, class.source = 'fold-show'}
...
```{r, fig.alt="Histogram representing the MEDS students' favorite activities in Santa Barbara. The most popular activities are surfing, going to the beach, and biking.", class.source = 'fold-show'}
